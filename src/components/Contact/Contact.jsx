    ...
    <div className="contact">
      <div className="contact-col">
        ...
        <p> Feel free to reach out through contact form or find our contact
            information below. Your inquiries and feedback are important to us
            as we strive to provide exceptional service to our university
            community.
        </p>
        <ul>
            <li><img src={mail_icon} alt="" />contact@Josekabz.dev</li>
            <li><img src={phone_icon} alt="" />+254 718047199</li>
