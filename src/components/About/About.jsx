      ...
      <div className="about-left">
       ...
       <div className="about-right">
            ...
            <p>Embark on a transformative educational journey with our
               ...
               curriculum is designed to empower students to excel in the dynamic field of education.</p>
               <p>With a focus on innovation, hands-on learning, and personalized mentorship
                ,our programs prepare aspiring eductaors to make a meaningful
                ...
                <p>Whether you aspire to become a teacher, administrator, counselor, or educational leader, our diverse range of programs
                    ...
                    potential in shapimg the future of education
                </p>
      </div>          
    </div>
  )
